...
export default function HowItWorks() {
  return (
    <section id="pilot" className="relative border-y border-white/5 bg-ink-soft py-28 sm:py-36">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-1 gap-px overflow-hidden rounded-3xl border border-white/10 bg-white/5 sm:grid-cols-2 lg:grid-cols-4">
          {steps.map((s, i) => (
            <Reveal key={s.n} delay={i * 0.1}>
              <div className="group h-full bg-ink p-8 transition-colors hover:bg-green/20">
